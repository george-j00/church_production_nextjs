...
import { deleteRegister, fetchAllRegisters } from "@/lib/actions/admin.actions"
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
const RegisterList = () => {
  ...
  useEffect(() => {
    const fetchRegisters = async () => {
      setIsLoading(true)
      try {
        const data = await fetchAllRegisters()
        setRegisterData(data)
        setIsLoading(false)
      } catch (error) {
        console.error("Error fetching registers list:", error)
      } finally {
        setIsLoading(false)
      }
    }
